...
ADRs capture the context, options considered, and reasoning behind significant architectural decisions. Once accepted, they serve as the authoritative record of *why* the system is built the way it is.
